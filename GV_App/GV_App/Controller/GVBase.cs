...
namespace GV_App.Controller
{
     ...
     public abstract class GVBase
     {
          ...
          protected List<ClientModel> ls { get; set; }
          #endregion
          ...
          /// </summary>
          public GVBase(string name, ConnectionType connectionType)
          {
               LocalName = name;
          ...
          public void NetworkCommsConfiguration()
          {
               ...
               if (FirstInitialisation)
               {
                    ...
                    NetworkComms.AppendGlobalIncomingPacketHandler<DataReceiveModel>("ClientMessage", HandleIncomingChatMessage);
               ...
               Connection.StartListening(ConnectionType.TCP, new IPEndPoint(IPAddress.Any, 3000)); // 192.168.43.189
               #endregion
          }
          /// <summary>
          ...
          public abstract void DisplayValuesFromClient(List<ClientModel> ls);
